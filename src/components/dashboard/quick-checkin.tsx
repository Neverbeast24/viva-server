  ...
  return (
    <>
      <motion.button
        ...
        className="focus-ring inline-flex items-center justify-center gap-2 self-start rounded-full bg-[#24212e] px-5 py-3 text-sm font-bold text-white shadow-lg transition hover:bg-[#7557ff]"
      >
            ...
            >
              <div className="mb-6 flex items-center justify-between">
                ...
                <button
                  ...
                  aria-label="Close"
                  onClick={() => setOpen(false)}
                  className="focus-ring grid size-9 place-items-center rounded-full bg-white/70 text-[#726d79] transition hover:bg-white"
                >
                  <X size={17} />
                </button>
              </div>
              ...
              <form action={formAction} className="space-y-4">
                    ...
                    {moods.map(([val, emoji]) => (
                      <button
                        ...
                        className={`focus-ring flex-1 rounded-2xl border py-3 text-xl transition ${
                          mood === val
                            ? "border-[#7557ff]/40 bg-white shadow-sm"
                ...
                <label className="block">
                  ...
                  <textarea
                    ...
                    className="w-full resize-none rounded-2xl border border-black/7 bg-white/70 px-4 py-3 text-sm outline-none transition focus:border-[#7557ff]/40 focus:ring-4 focus:ring-[#7557ff]/8"
                  />
                </label>
                ...
                <button
                  disabled={pending}
                  className="focus-ring flex w-full items-center justify-center gap-2 rounded-2xl bg-[#24212e] px-5 py-3.5 text-sm font-black text-white shadow-lg transition hover:bg-[#7557ff] disabled:opacity-60"
                >
                  {pending ? (
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="w-full rounded-2xl border border-black/7 bg-white/70 px-3 py-2.5 text-sm outline-none transition focus:border-[#7557ff]/40 focus:ring-4 focus:ring-[#7557ff]/8"
      />
    </label>
  );
}
